...
public class SinglyLinkedListTest {
    ...
    public void testAddFirst() {
        ...
        assertEquals(linkedList.getHead().getData().intValue(), 7);
        assertEquals(linkedList.getTail().getData().intValue(), 10);
    }
    ...
    public void testAddLast() {
        ...
        assertEquals(linkedList.getHead().getData().intValue(), 8);
        assertEquals(linkedList.getTail().getData().intValue(), 10);
    }
    ...
    public void testAddToListByAnyLocation() {
        ...
        assertEquals(linkedList.getHead().getData().intValue(), 101);
        assertEquals(linkedList.getTail().getData().intValue(), 104);
    }
